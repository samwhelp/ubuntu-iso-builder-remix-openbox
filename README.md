...
# ubuntu-iso-builder-remix-openbox
...
| `+` | `+` |
| [ubuntu-iso-builder-remix-openbox](https://samwhelp.github.io/ubuntu-iso-builder-remix-openbox/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-openbox) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-openbox](https://samwhelp.github.io/ubuntu-iso-builder-respin-openbox/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-openbox) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-openbox/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-openbox/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-openbox/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-openbox](https://github.com/samwhelp/ubuntu-iso-builder-remix-openbox)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-openbox.git
```


> change dir to `ubuntu-iso-builder-remix-openbox`

``` sh
cd ubuntu-iso-builder-remix-openbox
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-openbox/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-openbox/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-openbox/iso-profile/dist`
